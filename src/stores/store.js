...
const store = new Store({
  actions: {
    setData(context, data, name, saveData) {
      context.commit('setData', data);
      if (saveData) this.save(data,name);
    },
    ...
    post(context,{data,formName}) {
      // const { data } = context.state;
      this.setData(context, data, formName, true);
    },
    ...
    save(data,name) {
      ...
      if (_onPost) {
        ...
        post(_saveUrl, { task_data: data,name:name });
      }
    },
  },
